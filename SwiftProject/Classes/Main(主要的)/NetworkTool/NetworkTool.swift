...
public let Network = HWNetworking.shared
...
class NetworkTool: NSObject {
    ...
    static func request(_ convertible: URLConvertible, method: HTTPMethod = .get, parameters: Parameters? = nil, success: @escaping ResponseSuccess, failure: @escaping ResponseFail){
        AF.request(convertible, method: method, parameters: parameters) { (response) in
          print(response)
//            task.handleResponse(response: response)
        }
    }
    
    public func post(convertible: URLConvertible, parameters: Parameters? = nil, success: @escaping ResponseSuccess, failure: @escaping ResponseFail){
        NetworkTool.request(convertible, method: .post, parameters: parameters, success: success, failure: failure)
    }
    
    public func get(convertible: URLConvertible, parameters: Parameters? = nil,success: @escaping ResponseSuccess, failure: @escaping ResponseFail){
        NetworkTool.request(convertible, method: .get, parameters: parameters, success: success, failure: failure)
    }
